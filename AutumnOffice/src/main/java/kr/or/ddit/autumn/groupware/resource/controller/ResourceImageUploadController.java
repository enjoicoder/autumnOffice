...
import kr.or.ddit.autumn.web.matters.controller.MattersImageUploadController;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@Controller
public class ResourceImageUploadController {
	@Inject
	...
	@PostMapping(value = "/groupware/resource/resourceImageUpload.do", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
