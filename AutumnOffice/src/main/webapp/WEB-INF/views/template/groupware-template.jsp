...
<!--    Document Title-->
<!-- ===============================================-->
<title>${principal.realUser.comCnm} 그룹웨어</title>
...
<body>
	...
	<div class="offcanvas offcanvas-end settings-panel border-0"
		...
		<div class="offcanvas-header settings-panel-header bg-shape">
			...
			<button class="btn-close btn-close-white z-index-1 mt-0"
				type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
		</div>
		<div class="offcanvas-body scrollbar-overlay px-card h-100"
			id="themeController">
				...
				<div class="row gx-2">
					<div class="col-6">
						<input class="btn-check" id="themeSwitcherLight"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								...
								src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
					...
					<div class="col-6">
						<input class="btn-check" id="themeSwitcherDark" name="theme-color"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								class="img-fluid img-prototype mb-0"
								src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2" src="${pageContext.request.contextPath }/resources/groupware/assets/img/icons/left-arrow-from-left.svg"
						width="20" alt="" />
					<div class="flex-1">
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2" src="${pageContext.request.contextPath }/resources/groupware/assets/img/icons/arrows-h.svg" width="20"
						alt="" />
					<div class="flex-1">
			...
			<hr />
			<div class="d-flex align-items-start">
				<img class="me-2" src="${pageContext.request.contextPath }/resources/groupware/assets/img/icons/paragraph.svg" width="20"
					alt="" />
				<div class="flex-1">
				...
				<div class="row gx-2">
					<div class="col-6">
						<input class="btn-check" id="navbar-style-transparent"
							...
							src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/default.png" alt="" /><span
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-inverted" type="radio"
							...
							class="img-fluid img-prototype"
							src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/inverted.png" alt="" /><span
					...
					<div class="col-6">
						...
						<label class="btn d-block w-100 btn-navbar-style fs--1"
							...
							class="img-fluid img-prototype" src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/card.png"
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-vibrant" type="radio"
							...
							class="img-fluid img-prototype"
							src="${pageContext.request.contextPath }/resources/groupware/assets/img/generic/vibrant.png" alt="" /><span
							class="label-text"> Vibrant</span></label>
					</div>
				</div>
			</div>
			<div class="text-center mt-5">
				<img class="mb-4" src="${pageContext.request.contextPath }/resources/groupware/assets/img/icons/spot-illustrations/47.png"
					alt="" width="120" />
...
<!-- 			<div class="bg-soft-primary position-relative rounded-start" -->
