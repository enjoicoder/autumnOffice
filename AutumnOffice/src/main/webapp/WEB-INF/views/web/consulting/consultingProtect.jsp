...
@media (max-width: 768px) {
  ...
  #form__wrap {
	...
	<!-- -------------------------- -->
   	 <!-- 서비스 신청하기 개인정보 동의 페이지(웹페이지) -->
   	<!-- -------------------------- -->
    <br><br>
	<h1 id = "app-3" style="color:black; font-size:60px;">서비스 신청하기</h1>
	<br>
<body>
 <div class="wrap">
      <div class="logo"><h3>개인정보 보호방침</h3></div>
      <div class="contents">
        <form action="/" method="POST" id="form__wrap">
          <div class="terms__check__all">
            <input type="checkbox" name="checkAll" id="checkAll" />
            <label for="checkAll">이용약관, 개인정보 수집 및 이용,
          ...
          <ul class="terms__list">
            <li class="terms__box">
              <div class="input__check">
                ...
                <label for="termsOfService" class="required"
                  >AutumnOffice 이용약관 동의</label
                >
              </div>
              <div class="terms__content">
                여러분을 환영합니다. AutumnOffice 서비스 및 제품(이하 ‘서비스’)을 이용해
                주셔서 감사합니다. 본 약관은 다양한 AutumnOffice 서비스의 이용과 관련하여
                AutumnOffice 서비스를 제공하는 AutumnOffice 주식회사(이하 ‘AutumnOffice’)와 이를 이용하는
                AutumnOffice 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
                아울러 여러분의 AutumnOffice 서비스 이용에 도움이 될 수 있는 유익한
                정보를 포함하고 있습니다. AutumnOffice 서비스를 이용하시거나 AutumnOffice 서비스
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                개인정보보호법에 따라 AutumnOffice에 회원가입 신청하시는 분께 수집하는
            ...
            <li class="terms__box">
              ...
              <div class="terms__content">
                AutumnOffice에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(AutumnOffice앱
                알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도
                회원 체계로 운영하거나 AutumnOffice 가입 이후 추가 가입하여 이용하는
          ...
          <button type="submit" class="next-button" onclick="location.href='${pageContext.request.contextPath }/web/consulting/consultingForm.do'" disabled>서비스 신청하기</button>
        </form>
      </div>
    </div>
</body>        
