...
<br>
<h1 style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold; text-align:left; font-size:30px;"><span class="fas fa-caret-right"></span>&nbsp;임원 목록</h1>
<hr>
<span style="text-align: left;">임원 권한이 부여된 사원을 관리합니다.</span>
<br>
...
<script>
	...
	let makeTrTag = function(power){
		let tr = $("<tr>");
		let aRTag = $("<a style='font-weight:bold; font-family: 'IBM Plex Sans KR', sans-serif;'>").attr("href", "${pageContext.request.contextPath}/management/group/employee/powerDirectorDelete.do?what="+power.powNo)
		.text("권한 삭제");
		...
		$.ajax({
			...
			success : function(pagingVO) {
				...
				if(powerList.length > 0){
					...
					let tr = $("<tr>").html(
						$("<td>").attr("colspan", "6")
								 .html("임원이 없습니다. 임원 권한을 추가하셔야 합니다.")
					);
					trTags.push(tr);
				}
