...
<div class="card mb-3" style="padding:1%; text-align: center; ">
	<br>
	<h1 style="font-family: 'IBM Plex Sans KR', sans-serif; font-size:30px; text-align:left; font-weight:bold;"><span class="fas fa-user-tie"></span>&nbsp;부서장 권한 부여</h1>
	<hr>
	<br>
	<form:form id="employeeForm" method="post" modelAttribute="employee" enctype="multipart/form-data">
		...
		<br>
				<form:button type="submit" class="btn btn-outline-primary me-1 mb-1" style="width: 25%; bold;margin-right: 5%; font-weight:bold;">부서장 권한 부여</form:button>
