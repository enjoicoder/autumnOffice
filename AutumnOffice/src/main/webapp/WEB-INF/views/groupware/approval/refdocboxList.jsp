...
<div class="card md-3 docBox-wrapper">
	<!-- 메뉴 명 -->
	<br>
	<h3><span class="far fa-clipboard"></span>&nbsp;참조/열람 문서함</h3>
	<hr>
	<br>
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item" role="presentation">
			<a class="nav-link active px-2 px-md-3nav-link px-2 px-md-3" id="all" data-appstat="ref" data-bs-toggle="tab" href="#tab-all" role="tab" aria-controls="tab-all" aria-selected="true">
				참조
			</a>
		</li>
		<li class="nav-item" role="presentation">
			<a class="nav-link px-2 px-md-3" id="progress" data-appstat="read" data-bs-toggle="tab" href="#tab-progress" role="tab" aria-controls="tab-progress" aria-selected="false" tabindex="-1">
				열람
			</a>
    </ul>
	<br>
