...
<div class="card mb-3" style="padding:1%; text-align: center; font-weight: bold; font-family: 'IBM Plex Sans KR', sans-serif;">
	<br>
	<h3 style="font-weight: bold; font-size:30px; font-family: 'IBM Plex Sans KR', sans-serif; text-align:left;"><span class="fas fa-chart-pie"></span>&nbsp;설문 문항 수정</h3>
	<hr>
	<br>
	<form:form method="post" modelAttribute="surveyQuestion" enctype="multipart/form-data">
		...
		<tr>
			<th>설문 제목</th>
			<td>
				<form:select path="surNo" required="true" disabled="true" class="form-select"  style="font-family: 'IBM Plex Sans KR', sans-serif; ">
		...
		<tr>
			<th>문항 순번</th>
			<td>
				<form:input path="surqueTurn" required="true" readonly="true" class="form-control" style="font-family: 'IBM Plex Sans KR', sans-serif; "/>
		...
		<br>
				<form:button type="submit" class="btn btn-outline-primary me-1 mb-1" style="font-family: 'IBM Plex Sans KR', sans-serif; width: 25%;font-size: 15px;font-weight: bold;">설문 문항 수정</form:button>
