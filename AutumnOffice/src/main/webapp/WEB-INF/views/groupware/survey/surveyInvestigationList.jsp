...
<table class="table table-hover" style="width: 100%; vertical-align: middle;">
	<thead>
		<tr>
			<th style="font-size : 15px; width:5%;">번호</th>
			<th style="font-size : 15px; width:10%;">작성자</th>
			<th style="font-size : 15px; width:25%;">설문 제목</th>
			<th style="font-size : 15px; width:25%;">문항 내용</th>
			<th style="font-size : 15px; width:10%;">문항 유형</th>
			<th style="font-size : 15px; width:15%;">설문조사 작성일</th>
