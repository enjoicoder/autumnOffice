...
<div class="card mb-3">
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-auto"><a class="btn btn-falcon-primary btn-sm" href="${cPath }/groupware/mail/mailWriteView.do"><span class="fas fa-plus me-1" data-fa-transform="shrink-3"></span>메일작성</a></div>
              </div>
            </div>
            <div class="card-body fs--1 border-top border-200 p-0" id="emails">
             <h5 class="fs-0 px-3 pt-3 pb-2 mb-0 border-bottom border-200">${mail }</h5>
              <h5 class="fs-0 px-3 pt-3 pb-2 mb-0 border-bottom border-200">Unread</h5>
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="${cPath }/groupware/mail/mailDetail.do">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="fw-bold stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">이찬솔</a><span class="badge badge-soft-success badge-pill ms-2">NEW</span>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span class="fw-bold">메일함 테스트중</span><span class="mx-1">&ndash;</span><span>And they'd probably do a lot of damage to an...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/unsplash.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="fw-bold stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Unsplash Team</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span class="fw-bold">Get involved for International Women's Day - with link 👩</span><span class="mx-1">&ndash;</span><span>The link below is now clickable for Chrome users...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="${cPath }/resources/groupware/assets/img/generic/1.jpg" data-gallery="gallery-7"><span class="fas fa-image text-danger" data-fa-transform="grow-4"></span><span class="ms-2">Winter</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="${cPath }/resources/groupware/assets/img/generic/8.jpg" data-gallery="gallery-7"><span class="fas fa-image text-danger" data-fa-transform="grow-4"></span><span class="ms-2">Coffee</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/goodreads.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="fw-bold stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Goodreads</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span class="fw-bold">Goodreads Newsletter: March 5, 2019</span><span class="mx-1">&ndash;</span><span>The most anticipated books of spring, a rocking read, and more! Goodreads Spring...</span></a>
                    </div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="${cPath }/groupware/mail/mailDetail.do">
                <div class="btn-group btn-group-sm z-index-2 hover-actions end-0 me-3" style="width: 10rem;">
                  <button class="btn btn-light hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></button>
                  <button class="btn btn-light hover-bg-200" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/github.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">GitHub</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>[GitHub] Subscribed to technext/photogallery notifications</span><span class="mx-1">&ndash;</span><span>Hey there, we’re just writing to let you know that you’ve been...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/coursera.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Coursera</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Recommended: Server-side Development with NodeJS, Express and MongoDB</span><span class="mx-1">&ndash;</span><span>We combed our catalog and found courses...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fas fa-file-archive text-warning" data-fa-transform="grow-4"></span><span class="ms-2">syllabus</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/spectrum.jpg" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Spectrum</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Spectrum Weekly Digest: ZEIT watercooler, Escape Room!</span><span class="mx-1">&ndash;</span><span>You didn’t gain any reputation last week. Reputation is an...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/pinterest.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Pinterest</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Tony, 14 ideas in Pink saree</span><span class="mx-1">&ndash;</span><span>New ideas for you in Web Development...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/medium.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Medium</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Technology Brief: Who’s keeping us safe?</span><span class="mx-1">&ndash;</span><span>policy at Google, Twitter, and Pinterest, says, &quot;The team starts to feel like the...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/stripe.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Stripe</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Confirm your Stripe email address!</span><span class="mx-1">&ndash;</span><span>Before you can start accepting live payments, you need to confirm your email address...</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/logos/youtube.png" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Youtube</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Firebase just uploaded a video</span><span class="mx-1">&ndash;</span><span>Firebase has uploaded Understanding Cloud Functions: Configuration settings In the last...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fab fa-youtube text-youtube" data-fa-transform="grow-4"></span><span class="ms-2">Cloud Functions</span></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        <div class="avatar avatar-s">
                          <img class="rounded-soft" src="${cPath }/resources/groupware/assets/img/team/5.jpg" alt="" />

                        </div>
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="${cPath }/groupware/mail/mailDetail.do">Bruce Banner</a>
                        </div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="${cPath }/groupware/mail/mailDetail.do"><span>Invitation for migration</span><span class="mx-1">&ndash;</span><span>Bruce Wayne, you have an invitation of migration...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fas fa-file-pdf text-danger" data-fa-transform="grow-4"></span><span class="ms-2">Invitation</span></a>
                    </div>
                  </div>
                </div>
