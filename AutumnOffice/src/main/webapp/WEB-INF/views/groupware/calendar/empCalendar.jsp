...
.col-lg-6{
    ...
    <div class="container card">
    	<br>
    	<h3 class="mb-0" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold; float:left;font-size: 30px">${principal.realUser.empNm}님의 schedule</h3>
    	<hr>
	    ...
	    <div class="modal-content position-relative">
	      ...
	      <div class="modal-body p-0">
	        <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
	          <h4 class="mb-1 modalBtnContainer-addEvent" id="modalExampleDemoLabel">${principal.realUser.empNm}님의 일정 추가</h4>
	          <h4 class="mb-1 modalBtnContainer-modifyEvent" id="modalExampleDemoLabel">${principal.realUser.empNm} 일정 수정</h4>
	        </div>
	        <div class="p-4 pb-0">
	<!--           모달 바디 -->
	            <div class="mb-3"> 
...
let newEvent = function (start, end, eventType) {
    ...
    $('#save-event').on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "${cPath}/groupware/calendar/empCalendarInsert.do",
            data: eventData,
            success: function (response) {
            	console.log(response);
            	 location.href = "${cPath}/groupware/calendar/empCalendarList.do"
                //DB연동시 중복이벤트 방지를 위한
...
//         editEnd.val(moment(event.end).subtract(1, 'days').format('YYYY-MM-DD HH:mm'))
    ...
    $('#Event').on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "${cPath}/groupware/calendar/empCalendarUpdate.do",
            data: modifiedData,
            success: function (response) {
            	location.reload();
...
//		             .append('<p><strong>구분:</strong> ' + event.type + '</p>')
		      ...
		      events: function (start, end, timezone, callback) {
		        $.ajax({
		          ...
		          url: "${cPath}/groupware/calendar/empCalendarList.do",
		          data: {
		      ...
		      eventDrop: function (event, delta, revertFunc, jsEvent, ui, view) {
		        ...
		        $.ajax({
				 ...
				 toastr.info('수정 확인: ' + newDates.startDate + ' ~ ' + newDates.endDate);
		          }
		        });
